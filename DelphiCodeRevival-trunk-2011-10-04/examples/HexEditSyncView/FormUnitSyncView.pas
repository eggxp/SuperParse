...
begin
   if FDoSync then begin
      if MPHexEditor1.Focused then MPHexEditor2.SyncView(MPHexEditor1, FSyncOffset)
      else if MPHexEditor2.Focused then MPHexEditor1.SyncView(MPHexEditor2, -FSyncOffset)
   end;
end;
